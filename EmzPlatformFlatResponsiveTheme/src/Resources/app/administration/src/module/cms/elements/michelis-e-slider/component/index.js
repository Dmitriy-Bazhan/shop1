import template from './michelis-e-slider-component.html.twig';
import './michelis-e-slider-component.scss';

const { Component, Mixin } = Shopware;

Component.register('michelis-e-slider-component', {
    template,
    ...
    methods: {
        createdComponent() {
            ...
            this.initElementData('michelis-e-slider');
